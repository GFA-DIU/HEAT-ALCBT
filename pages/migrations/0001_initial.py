# Generated by Django 5.1.2 on 2024-12-23 12:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='AssemblySubCategory',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255)),
                ('numeric_identifier', models.PositiveIntegerField()),
            ],
            options={
                'verbose_name': 'Assembly Subcategorie',
                'verbose_name_plural': 'Assembly Subcategories',
                'ordering': ['numeric_identifier'],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(choices=[('m', 'Meter'), ('m2', 'Square Meter'), ('m3', 'Cubic Meter'), ('kg', 'Kilogram'), ('tones', 'Tones'), ('pcs', 'Pieces'), ('kwh', 'Kilowatt Hour'), ('l', 'Liter'), ('m2r1', 'Square Meter Rate 1'), ('km', 'Kilometer'), ('tones_km', 'Tones per Kilometer'), ('kgm3', 'Kilogram per Cubic Meter'), ('unknown', 'Unknown'), ('mj', 'Megajoule'), ('kgco2e', 'kgCO2e'), ('kgcfc11e', 'kgCFC11e'), ('kgnmvoce', 'kg NMVOC eq.'), ('moleh+e', 'Mole of H+ eq.'), ('molene', 'Mole of N eq.'), ('kgpe', 'kg P eq.'), ('kgne', 'kg N eq.'), ('m3we', 'm³ world equiv.'), ('kgsbe', 'kg Sb eq.')], default='unknown', max_length=20, verbose_name='Impact Unit')),
            ],
        ),
        migrations.CreateModel(
            name='AssemblyCategorySubcategory',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('description', models.TextField()),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pages.assemblycategory')),
                ('subcategory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pages.assemblysubcategory')),
            ],
        ),
        migrations.CreateModel(
            name='Assembly',
            fields=[
                ...
                ('dimension', models.CharField(choices=[('area', 'Area-Type'), ('length', 'Length-Type'), ('mass', 'Mass-Type'), ('volume', 'Volume-Type')], default='area', max_length=20, verbose_name='Assembly type')),
                ...
                ('classification', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='pages.assemblycategorysubcategory')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='subcategories',
            field=models.ManyToManyField(related_name='categories', through='pages.AssemblyCategorySubcategory', to='pages.assemblysubcategory'),
        ),
        migrations.CreateModel(
            name='Building',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.DecimalField(decimal_places=3, default=0, help_text='How many of components', max_digits=10, verbose_name='Quantity')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('declared_unit', models.CharField(choices=[('m', 'Meter'), ('m2', 'Square Meter'), ('m3', 'Cubic Meter'), ('kg', 'Kilogram'), ('tones', 'Tones'), ('pcs', 'Pieces'), ('kwh', 'Kilowatt Hour'), ('l', 'Liter'), ('m2r1', 'Square Meter Rate 1'), ('km', 'Kilometer'), ('tones_km', 'Tones per Kilometer'), ('kgm3', 'Kilogram per Cubic Meter'), ('unknown', 'Unknown'), ('mj', 'Megajoule'), ('kgco2e', 'kgCO2e'), ('kgcfc11e', 'kgCFC11e'), ('kgnmvoce', 'kg NMVOC eq.'), ('moleh+e', 'Mole of H+ eq.'), ('molene', 'Mole of N eq.'), ('kgpe', 'kg P eq.'), ('kgne', 'kg N eq.'), ('m3we', 'm³ world equiv.'), ('kgsbe', 'kg Sb eq.')], default='unknown', max_length=20, verbose_name='Declared Unit')),
                ...
                ('declared_amount', models.DecimalField(decimal_places=3, max_digits=10, verbose_name='Reference Quantity of EPD')),
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cities_light.city')),
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cities_light.country')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ...
        migrations.AddField(
            model_name='assembly',
            name='impacts',
            field=models.ManyToManyField(related_name='assemblies', through='pages.AssemblyImpact', to='pages.impact'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_unit', models.CharField(choices=[('m', 'Meter'), ('m2', 'Square Meter'), ('m3', 'Cubic Meter'), ('kg', 'Kilogram'), ('tones', 'Tones'), ('pcs', 'Pieces'), ('kwh', 'Kilowatt Hour'), ('l', 'Liter'), ('m2r1', 'Square Meter Rate 1'), ('km', 'Kilometer'), ('tones_km', 'Tones per Kilometer'), ('kgm3', 'Kilogram per Cubic Meter'), ('unknown', 'Unknown'), ('mj', 'Megajoule'), ('kgco2e', 'kgCO2e'), ('kgcfc11e', 'kgCFC11e'), ('kgnmvoce', 'kg NMVOC eq.'), ('moleh+e', 'Mole of H+ eq.'), ('molene', 'Mole of N eq.'), ('kgpe', 'kg P eq.'), ('kgne', 'kg N eq.'), ('m3we', 'm³ world equiv.'), ('kgsbe', 'kg Sb eq.')], default='unknown', max_length=20, verbose_name='Unit for quantity of EPD')),
                ('quantity', models.DecimalField(decimal_places=3, max_digits=10, verbose_name='Quantity of EPD')),
                ('assembly', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pages.assembly')),
                ('epd', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pages.epd')),
            ],
            options={
