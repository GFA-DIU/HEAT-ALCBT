# Generated by Django 5.1.2 on 2025-04-12 12:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dimension', models.CharField(choices=[('area', 'm²'), ('length', 'm'), ('mass', 'kg'), ('volume', 'm³')], default='area', max_length=20, verbose_name='Assembly type')),
                ('comment', models.TextField(blank=True, null=True, verbose_name='Comment')),
                ('description', models.TextField(blank=True, null=True, verbose_name='Description')),
                ('name', models.CharField(max_length=255)),
                ('is_boq', models.BooleanField(default=False)),
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.customcity')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_residents', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Approx. number of residents')),
                ('hours_per_workday', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(24)], verbose_name='Operation hours per workday')),
                ('workdays_per_week', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(7)], verbose_name='Operation days per week')),
                ('weeks_per_year', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(52)], verbose_name='Operation weeks per year')),
                ('heating_temp', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(120)], verbose_name='Typical Heating Temperature')),
                ('heating_temp_unit', models.CharField(blank=True, choices=[('celsius', '°Celsius'), ('fahrenheit', '°Fahrenheit')], max_length=20, null=True, verbose_name='Heating Temperature Unit')),
                ('cooling_temp', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(120)], verbose_name='Typical Cooling Temperature (Celsius)')),
                ('cooling_temp_unit', models.CharField(blank=True, choices=[('celsius', '°Celsius'), ('fahrenheit', '°Fahrenheit')], max_length=20, null=True, verbose_name='Cooling Temperature Unit')),
                ('heating_type', models.CharField(blank=True, choices=[('room-heater', 'Room Heaters'), ('reverse_cycle_ac', 'Reverse Cycle Air Conditioners (Heat Pumps)'), ('split-ac', 'Split AC with Heating Mode'), ('packaged-ac', 'Packaged Air Conditioners with Electric Heating Coils'), ('boiler', 'Boiler')], max_length=50, null=True, verbose_name='Heating Type')),
                ('heating_capacity', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Heating Capacity')),
                ('heating_unit', models.CharField(blank=True, choices=[('kw', 'Kilowatt')], max_length=20, null=True, verbose_name='Heating Unit')),
                ('cooling_type', models.CharField(blank=True, choices=[('window-ac', 'Window Air Conditioners'), ('split-ac', 'Split Air Conditioners'), ('vrf-system', 'Variable Refrigerant Flow (VRF) Systems'), ('packaged-ac', 'Packaged Air Conditioners'), ('chiller-system', 'Chiller Systems')], max_length=50, null=True, verbose_name='Coolingting Type')),
                ('cooling_capacity', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Heating Capacity')),
                ('cooling_unit', models.CharField(blank=True, choices=[('tr', 'Ton of Refrigeration'), ('kw', 'Kilowatt')], max_length=20, null=True, verbose_name='Cooling Unit')),
                ('ventilation_type', models.CharField(blank=True, choices=[('ahu', 'Air Handling Units (AHUs)'), ('fcu', 'Fan Coil Units (FCUs)'), ('cassette-ac', 'Ceiling or Wall-Mounted Cassette Acs'), ('doas', 'DOAS')], max_length=50, null=True, verbose_name='Ventilation Type')),
                ('ventilation_capacity', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Ventilation Capacity')),
                ('ventilation_unit', models.CharField(blank=True, choices=[('m^3/h', 'Cubic Meters per Hour'), ('cfm', 'Cubic Feet per Minute')], max_length=20, null=True, verbose_name='Ventilation Unit')),
                ('lighting_type', models.CharField(blank=True, choices=[('led', 'LED (Light Emitting Diode) Lights'), ('cfl', 'CFL (Compact Fluorescent Lamp) Lights'), ('fluorescent-tube', 'T5 and T8 Fluorescent Tube Lights')], max_length=50, null=True, verbose_name='Lighting Type')),
                ('lighting_capacity', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Lighting Capacity')),
                ('lighting_unit', models.CharField(blank=True, choices=[('kw', 'Kilowatt')], max_length=20, null=True, verbose_name='Lighting Unit')),
                ...
                ('cond_floor_area', models.DecimalField(blank=True, decimal_places=2, help_text='Gross floor area [m^2]', max_digits=10, null=True, verbose_name='Conditioned Floor Area')),
                ...
                ('reference_period', models.IntegerField(default=50, help_text='Number of years of building usage', verbose_name='Ref. period')),
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.customcity')),
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cities_light.country')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('region', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.customregion')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('official', 'From a verified ILCD+EPD source'), ('custom', 'Created by user'), ('generic', 'Representative EPD for a country')], max_length=255, verbose_name='Type')),
                ('declared_amount', models.DecimalField(decimal_places=2, max_digits=10, validators=[django.core.validators.MinValueValidator(Decimal('0.01'))], verbose_name='Reference Quantity of EPD')),
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.customcity')),
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cities_light.country')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('building', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='operational_products', to='pages.building')),
                ('epd', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pages.epd')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_unit', models.CharField(choices=[('cm', 'Centimeter'), ('m', 'Meter'), ('cm2', 'Square Centimeter'), ('m2', 'Square Meter'), ('m3', 'Cubic Meter'), ('kg', 'Kilogram'), ('tones', 'Tones'), ('pcs', 'Pieces'), ('kwh', 'Kilowatt Hour'), ('l', 'Liter'), ('m2r1', 'Square Meter Rate 1'), ('km', 'Kilometer'), ('tones_km', 'Tones per Kilometer'), ('kgm3', 'Kilogram per Cubic Meter'), ('unknown', 'Unknown'), ('percent', 'Percent'), ('mj', 'Megajoule'), ('kgco2e', 'kgCO2e'), ('kgcfc11e', 'kgCFC11e'), ('kgnmvoce', 'kg NMVOC eq.'), ('moleh+e', 'Mole of H+ eq.'), ('molene', 'Mole of N eq.'), ('kgpe', 'kg P eq.'), ('kgne', 'kg N eq.'), ('m3we', 'm³ world equiv.'), ('kgsbe', 'kg Sb eq.'), ('tr', 'Ton of Refrigeration'), ('kw', 'Kilowatt'), ('m^3/h', 'Cubic Meters per Hour'), ('cfm', 'Cubic Feet per Minute'), ('celsius', '°Celsius'), ('fahrenheit', '°Fahrenheit'), ('liter', 'Liter')], default='unknown', max_length=20, verbose_name='Unit for quantity of EPD')),
                ('quantity', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Quantity of EPD')),
                ('building', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='simulated_operational_products', to='pages.building')),
                ('epd', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pages.epd')),
            ],
            options={
                'abstract': False,
