# Generated by Django 5.1.2 on 2024-12-05 14:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='EPD',
            fields=[
                ('epdlcax_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, to='pages.epdlcax')),
                ('basemodel_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='pages.basemodel')),
                ('source', models.CharField(max_length=255, verbose_name='Source')),
                ('type', models.CharField(max_length=255, verbose_name='Type')),
            ],
            bases=('pages.basemodel', 'pages.epdlcax'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='assembly',
            name='classification',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='pages.assemblycategorysubcategory'),
        ),
        migrations.AddField(
            model_name='assembly',
            name='country',
        ...
        migrations.AddField(
            model_name='assembly',
            name='products',
            field=models.ManyToManyField(blank=True, related_name='assemblies', through='pages.AssemblyProduct', to='pages.product'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='product',
            name='epd',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pages.epd'),
        ),
        migrations.CreateModel(
            name='EPDImpact',
            fields=[
