# Generated by Django 5.1.2 on 2025-01-07 16:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('construction_year', models.IntegerField(blank=True, default=1900, null=True, verbose_name='Year of Construction')),
                ...
                ('cond_floor_area', models.DecimalField(blank=True, decimal_places=2, default=0, help_text='Gross floor area [m^2]', max_digits=10, null=True, verbose_name='Conditional Floor Area')),
                ('floors_above_ground', models.IntegerField(blank=True, default=0, help_text='Number of floors above', null=True, validators=[django.core.validators.MaxValueValidator(1000)], verbose_name='Floors above ground')),
                ('floors_below_ground', models.IntegerField(blank=True, default=0, help_text='Number of floors below', null=True, validators=[django.core.validators.MaxValueValidator(100)], verbose_name='Floors below ground')),
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cities_light.city')),
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cities_light.country')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reporting_life_cycle', models.IntegerField(default=50, help_text='Reporting life-cycle for assembly', validators=[django.core.validators.MaxValueValidator(10000)], verbose_name='Reporting life-cycle')),
